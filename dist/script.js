...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Пожалуйста, выберите и размер и материал картины';
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input.getAttribute('data_upload')) {
        preventDefaults(e);
        var formData = new FormData();

        _toConsumableArray(input.files).forEach(function (file) {
          formData.append('image', file);
          Object(_services_requests__WEBPACK_IMPORTED_MODULE_12__["postData"])('assets/server.php', formData).then(function (res) {
            console.log(res);
          });
        });
      }
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResours"])('http://localhost:3000/styles').then(function (res) {
...
var getResours = function getResours(url) {
  var res;
  return regeneratorRuntime.async(function getResours$(_context2) {
    while (1) {
